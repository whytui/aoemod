...
void WxBinSeqWindow::OnForceReset(wxCommandEvent& event) {
	int mresult = wxMessageBox(_T("Are you sure you want to reset this sequence to default ? This may corrupt the file."), "RockNRor Admin", wxYES_NO | wxICON_ASTERISK, this);
	if (mresult == wxNO) {
		return;
	}
