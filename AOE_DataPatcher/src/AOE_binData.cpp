...
#define COUNT_obsoletes_10c 23
#define COUNT_ROR_API_10c 100
...
void AOE_binData::InitData() {
	...
	//this->windowedMode_10b.SetCount();
...
void AOE_binData::InitWindowedMode() {
	int i = 0;
	...
	NEXT_INITSEQ_2_NOVAR(this->windowedMode_10c.GetBinSeqDefinition(i),
		ScreenToClient2,
		"Fix ScreenToClient call. Like ScreenToClient2 of VEG's mod binseq",
		0x49FC8,
...
void AOE_binData::InitTechFixes_10b() {
	...
	NEXT_INITSEQ_3_NOVAR(
		...
		(0x88, 0x08, 0x04, 0x00, 0x00, 0x85, 0xc9, 0x75, 0x12, 0xB8, 0x01, 0x00, 0x00, 0x00), // default=yes
		(0x88, 0x08, 0x04, 0x00, 0x00, 0x85, 0xc9, 0x75, 0x00, 0xB8, 0x01, 0x00, 0x00, 0x00),
		(0x88, 0x08, 0x04, 0x00, 0x00, 0x85, 0xc9, 0x90, 0x90, 0xB8, 0x01, 0x00, 0x00, 0x00),
		FM_ON,
		FM_OFF,
...
void AOE_binData::InitROR_API() {
	...
	NEXT_INITSEQ_2_NOVAR(this->ROR_API_10c.GetBinSeqDefinition(i),
		ManageTacAIUpdate,
		"Call customROR features for tactical AI updates. SNScalingFrequency unit is seconds instead of minutes if you enable this option.",
		0x0D099E,
	...
	NEXT_INITSEQ_2_NOVAR(this->ROR_API_10c.GetBinSeqDefinition(i),
		...
		"Call customROR to manage an attacked unit target change (military, villagers). This avoid stuck units (eg. against 2 priests).",
		0x011D56,
	...
	NEXT_INITSEQ_2_NOVAR(this->ROR_API_10c.GetBinSeqDefinition(i),
		...
		"Call customROR to manage an attacked unit target change (converting priest). This avoid stuck units (eg. against 2 priests).",
		0x011F25,
	...
	NEXT_INITSEQ_2_NOVAR(this->ROR_API_10c.GetBinSeqDefinition(i),
		...
		"Call customROR to manage AI military units reaction when an enemy tower is in his town.",
		0x0E37A7,
	...
	NEXT_INITSEQ_2_NOVAR(this->ROR_API_10c.GetBinSeqDefinition(i),
		...
		"Call customROR to manage reaction to being attacked, considering current action, for villagers.",
		0xE39D1,
	...
	NEXT_INITSEQ_2_NOVAR(this->ROR_API_10c.GetBinSeqDefinition(i),
		...
		"Call customROR to manage reaction to being attacked, considering current action. Especially to remove priests hesitation.",
		0xD8291,
	...
	NEXT_INITSEQ_2_NOVAR(this->ROR_API_10c.GetBinSeqDefinition(i),
		...
		"Call customROR to properly handle canConvertUnit function and fix stuck priests bug (with unfinished buildings).",
		0x0E4FFD,
	...
	NEXT_INITSEQ_2_NOVAR(this->ROR_API_10c.GetBinSeqDefinition(i),
		...
		"Manage CustomROR button click in in-game menu.",
		0x034245,
	...
	NEXT_INITSEQ_2_NOVAR(this->ROR_API_10c.GetBinSeqDefinition(i),
		...
		"Code to manage CustomROR menu button click.",
		0x0031365,
	...
	NEXT_INITSEQ_2_NOVAR(this->ROR_API_10c.GetBinSeqDefinition(i),
		...
		"Allows customROR to customize and improve unit selection/edition in game or editor.",
		0x11A6E7,
	...
	*/
	...
	NEXT_INITSEQ_2_NOVAR(this->ROR_API_10c.GetBinSeqDefinition(i),
		...
		"[Optional] Call customROR to fix timer bug on fast computers.",
		0x011D913,
	...
	NEXT_INITSEQ_2_NOVAR(this->ROR_API_10c.GetBinSeqDefinition(i),
		...
		"[Optional] Call customROR to manage autofix for ManageGameTimerSkip and provide statistics.",
		0x011D9E2,
...
void AOE_binData::InitObsoletes() {
	...
	NEXT_INITSEQ_2_NOVAR(this->obsoletes_10c.GetBinSeqDefinition(i),
		...
		"[OBSOLETE] Do not use because of possible impact on FPU stack. Call customROR to manage autofix for ManageGameTimerSkip and provide statistics.",
		0x011D9DF,
