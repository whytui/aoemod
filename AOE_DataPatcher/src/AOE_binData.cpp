...
void AOE_binData::InitObsoletes() {
	...
	NEXT_INITSEQ_2_NOVAR(this->obsoletes_10c.GetBinSeqDefinition(i),
		...
		"Obsolete call to customROR features for tactical AI updates. Do not use, it changed SNScalingFrequency unit to seconds instead of minutes and had impact on the game.",
		0x0D099E,
