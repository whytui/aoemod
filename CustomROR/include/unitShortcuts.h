...
/* This files handles custom unit shortcuts
 ...
 In CustomROR, we use <-1 values to handle more shortcuts, without messing with unit groups.
 - Values -11 to -2 represent shortcuts 10-19 (numpad keys).
 */

// Converts a unit.shortcutNumber value into a REAL shortcut ID (1-10 in standard game, 1-20 in customROR)
