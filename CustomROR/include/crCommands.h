...
#define CST_CUSTOM_BUTTONID_AUTO_ATTACK_NOT_VILLAGERS 8
#define CST_CUSTOM_BUTTONID_AUTO_ATTACK_NOT_BUILDINGS 9
#define CST_CUSTOM_BUTTONID_AUTO_ATTACK_DISABLED 10
#define CST_CUSTOM_BUTTONID_AUTO_ATTACK_SET_DEFAULT 11
