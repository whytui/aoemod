...
bool UnitTargeting::TaskActiveUnitGroup(STRUCT_TAC_AI *tacAI, STRUCT_UNIT_GROUP *unitGroup) {
	...
	/*if (unitGroupIsAlmostIdle) {
		...
		AOE_METHODS::UNIT_GROUP::TaskUnitGroup(unitGroup, tacAI, UNIT_GROUP_TASK_IDS::CST_UGT_EXPLORE, 1, true);
	}*/
	return false;
	...
	// If group is away from my town and/or partially inactive ?
		...
		if (myTC && myTC->IsCheckSumValidForAUnitClass() && myTC->unitDefinition && myTC->unitDefinition->IsCheckSumValidForAUnitClass()) {
			// TEST1 : retreat
			/*if (unitGroup->currentTask != UNIT_GROUP_TASK_IDS::CST_UGT_RETREAT) {
				...
				unitGroup->retreatPosZ = 1;
				unitGroup->currentTask = UNIT_GROUP_TASK_IDS::CST_UGT_RETREAT;
				unitGroup->unknown_resetOrg = 0;
				AOE_METHODS::UNIT_GROUP::TaskUnitGroup(unitGroup, tacAI, UNIT_GROUP_TASK_IDS::CST_UGT_RETREAT, 1, true);
			}*/
			// TEST2 : defend
			if (unitGroup->currentTask != UNIT_GROUP_TASK_IDS::CST_UGT_DEFEND_UNIT) {
				...
				AOE_METHODS::UNIT_GROUP::TaskUnitGroup(unitGroup, tacAI, UNIT_GROUP_TASK_IDS::CST_UGT_DEFEND_UNIT, 1, true);
			}
		}
	//}
