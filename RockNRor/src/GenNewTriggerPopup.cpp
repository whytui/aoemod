...
void GenNewTriggerPopup::_AddPopupContent() {
	...
	this->AddTextBox(popup, &this->edtSampleTriggerText, localizationHandler.GetTranslation(CRLANG_ID_TRG_REFER_TO_ROCKNRORADMIN_FOR_DOC, "Please run RockNRorAdmin.exe to get full documentation on triggers."), 1000, splitScreenXPos + 20, 250, splitScreenXPos - 40, remainingHeight, false, true, false);
