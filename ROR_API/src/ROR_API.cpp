...
void DispatchToCustomCode() {
	if ((REG_values[global_conf.currentCalls - 1].return_address < AOE_OFFSETS::ADDR_EXE_MIN) ||
		(REG_values[global_conf.currentCalls - 1].return_address > AOE_OFFSETS::ADDR_EXE_MAX)) {
