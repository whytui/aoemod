...
namespace ROR_STRUCTURES_10C
{
	...
	class STRUCT_UNITDEF_DOPPLEGANGER;
	class STRUCT_UNITDEF_DEAD_FISH;
	class STRUCT_UNITDEF_BIRD;
	class STRUCT_UNITDEF_TYPE50;
	class STRUCT_UNITDEF_PROJECTILE;
	class STRUCT_UNITDEF_LIVING;
	class STRUCT_UNITDEF_BUILDING;
	class STRUCT_UNITDEF_TREE;
	class STRUCT_UNIT;
	...
	public:
		...
		short int costUsed; // sometimes used as a byte
	};
	...
	*/
	...
	public:
		...
		unsigned long int objectsToPlaceOnMapInfoCount;
	...
	public:
		...
		STRUCT_DEF_CIVILIZATION **civilizationDefinitions; // +48. A pointer to the array of pointers to civ definitions. Array size is civCount
	...
	public:
		...
		// 0x1A0
		long int strategyElementSequence; // = number of strategy elements
	...
	public:
		...
		AOE_CONST_INTERNAL::INTERNAL_ACTION_ID GetExpectedInternalActionId() { return AOE_CONST_INTERNAL::INTERNAL_ACTION_ID::CST_IAI_CONVERT; } // really unsure :(
	};
	...
	public:
		...
		unsigned long int unknown_048; // value from command +0x0C ?
		char unknown_04C;
...
#define CHECKSUM_ACTION_PRODUCE_FARM_FOOD 0x0054261C
	...
	public:
		...
		short int civUnitDefCount; // a civ has its own unit definitions...
	...
	*/
	...
	public:
		...
		float positionZ; // Read only, because it's updated automatically according to map position(X,Y)
		float resourceValue; // See resourceValue. Faith (0-100) for priests, food for hunter...
		char unitStatus; // 0=being_built, 2=ready, at least for buildings... To confirm exact roles. Values=0,1,2,3,5,7,8=max=toDestroy?
		char isNotCreatable; // +49. 1 if the unit is a "not-creatable" unit, like cliffs, etc. Always 1 in parent constructors, set to 0 in "creatable-level" constructor.
