...
namespace AOE_STRUCTURES {
	...
	long int GuessRORStructureSize(void *pData) {
		...
		GET_STRUCT_SIZE_IF_MATCHING(STRUCT_UI_BUTTON_COMBOBOX);
		...
		GET_STRUCT_SIZE_IF_MATCHING(STRUCT_GAME_TIMELINE);
		GET_STRUCT_SIZE_IF_MATCHING(STRUCT_UNKNOWN_PATH_FINDING);
	...
	char *GuessRORStructure(void *pData) {
		...
		GET_STRUCT_NAME_IF_MATCHING(STRUCT_UI_BUTTON_COMBOBOX);
		...
		GET_STRUCT_NAME_IF_MATCHING(STRUCT_UNKNOWN_PATH_FINDING);
