...
namespace AOE_STRUCTURES {
	...
	long int GuessRORStructureSize(void *pData) {
		...
		GET_STRUCT_SIZE_IF_MATCHING(STRUCT_ACTION_ARTEFACT_CAPTURE);
		GET_STRUCT_SIZE_IF_MATCHING(STRUCT_ACTION_ATTACK);
		GET_STRUCT_SIZE_IF_MATCHING(STRUCT_ACTION_BUILD);
		GET_STRUCT_SIZE_IF_MATCHING(STRUCT_ACTION_CONVERSION);
		GET_STRUCT_SIZE_IF_MATCHING(STRUCT_ACTION_DISCOVERY_ARTEFACT);
		GET_STRUCT_SIZE_IF_MATCHING(STRUCT_ACTION_EXPLORE);
		GET_STRUCT_SIZE_IF_MATCHING(STRUCT_ACTION_FLY_BIRD);
		GET_STRUCT_SIZE_IF_MATCHING(STRUCT_ACTION_GARRISON_ENTER);
		GET_STRUCT_SIZE_IF_MATCHING(STRUCT_ACTION_GATHER_WITHOUT_ATTACK);
		GET_STRUCT_SIZE_IF_MATCHING(STRUCT_ACTION_GATHER_WITH_ATTACK);
		GET_STRUCT_SIZE_IF_MATCHING(STRUCT_ACTION_GENERATE_WONDER_VICTORY);
		GET_STRUCT_SIZE_IF_MATCHING(STRUCT_ACTION_HEAL);
		//GET_STRUCT_SIZE_IF_MATCHING(STRUCT_ACTION_LINK); // No checksum
		GET_STRUCT_SIZE_IF_MATCHING(STRUCT_ACTION_MAKE_OBJECT);
		GET_STRUCT_SIZE_IF_MATCHING(STRUCT_ACTION_MAKE_TECH);
		GET_STRUCT_SIZE_IF_MATCHING(STRUCT_ACTION_MOVE);
		GET_STRUCT_SIZE_IF_MATCHING(STRUCT_ACTION_PRODUCE_FARM_FOOD);
		GET_STRUCT_SIZE_IF_MATCHING(STRUCT_ACTION_PROJECTILE);
		GET_STRUCT_SIZE_IF_MATCHING(STRUCT_ACTION_REPAIR);
		GET_STRUCT_SIZE_IF_MATCHING(STRUCT_ACTION_TRADE);
		GET_STRUCT_SIZE_IF_MATCHING(STRUCT_ACTION_TRANSPORT);
		GET_STRUCT_SIZE_IF_MATCHING(STRUCT_ACTIVE_ANIMATED_SPRITE);
		GET_STRUCT_SIZE_IF_MATCHING(STRUCT_ACTIVE_SPRITE);
		GET_STRUCT_SIZE_IF_MATCHING(STRUCT_ACTIVE_SPRITE_LIST);
		...
		GET_STRUCT_SIZE_IF_MATCHING(STRUCT_CIVILIZATION_DEF);
		//GET_STRUCT_SIZE_IF_MATCHING(STRUCT_UNIT_COMMAND_DEF); // No checksum
		GET_STRUCT_SIZE_IF_MATCHING(STRUCT_UNIT_COMMAND_DEF_HEADER);
		...
		GET_STRUCT_SIZE_IF_MATCHING(STRUCT_GAME_TIMELINE);
		...
		GET_STRUCT_SIZE_IF_MATCHING(STRUCT_RMM_DB_CONTROLLER);
		...
		GET_STRUCT_SIZE_IF_MATCHING(STRUCT_OBJECT_LIST);
		...
		GET_STRUCT_SIZE_IF_MATCHING(STRUCT_SCENARIO_HEADER);
		//GET_STRUCT_SIZE_IF_MATCHING(STRUCT_SCORE_ELEM); // No checksum
		GET_STRUCT_SIZE_IF_MATCHING(STRUCT_VICTORY_CONDITIONS);
		...
		GET_STRUCT_SIZE_IF_MATCHING(STRUCT_INFLUENCE_MAP);
		...
		GET_STRUCT_SIZE_IF_MATCHING(STRUCT_UI_DROPDOWN_BUTTON);
		GET_STRUCT_SIZE_IF_MATCHING(STRUCT_UI_BUTTON_WITH_NUMBER);
		//GET_STRUCT_SIZE_IF_MATCHING(STRUCT_UI_CAMPAIGN_EDITOR);
		GET_STRUCT_SIZE_IF_MATCHING(STRUCT_UI_CREDITS_SCREEN);
		GET_STRUCT_SIZE_IF_MATCHING(STRUCT_UI_COMBOBOX);
		GET_STRUCT_SIZE_IF_MATCHING(STRUCT_UI_DIALOG_BASE);
		GET_STRUCT_SIZE_IF_MATCHING(STRUCT_UI_DIAMOND_MAP);
		GET_STRUCT_SIZE_IF_MATCHING(STRUCT_UI_DIPLOMACY_DIALOG);
		//GET_STRUCT_SIZE_IF_MATCHING(STRUCT_UI_DRAW_AREA); // no checksum
		GET_STRUCT_SIZE_IF_MATCHING(STRUCT_UI_EASY_PANEL);
		GET_STRUCT_SIZE_IF_MATCHING(STRUCT_UI_F11_POP_LABEL);
		GET_STRUCT_SIZE_IF_MATCHING(STRUCT_GAME_COLORED_INFO_LABEL);
		GET_STRUCT_SIZE_IF_MATCHING(STRUCT_UI_GAME_SETTINGS);
		GET_STRUCT_SIZE_IF_MATCHING(STRUCT_UI_HORIZONTAL_SLIDER);
		GET_STRUCT_SIZE_IF_MATCHING(STRUCT_UI_VERTICAL_SLIDER);
		GET_STRUCT_SIZE_IF_MATCHING(STRUCT_UI_IN_GAME_MAIN);
		GET_STRUCT_SIZE_IF_MATCHING(STRUCT_UI_IN_GAME_MENU);
		GET_STRUCT_SIZE_IF_MATCHING(STRUCT_UI_IN_GAME_OPTIONS);
		GET_STRUCT_SIZE_IF_MATCHING(STRUCT_UI_MESSAGE_PANEL);
		...
		GET_STRUCT_SIZE_IF_MATCHING(STRUCT_UI_MP_SETUP_SCREEN);
		//GET_STRUCT_SIZE_IF_MATCHING(STRUCT_UI_LIST_ITEM); // No checksum
		//GET_STRUCT_SIZE_IF_MATCHING(STRUCT_UI_LOAD_SAVED_GAME);
		GET_STRUCT_SIZE_IF_MATCHING(STRUCT_UI_PLAYER_RESOURCE_VALUES);
		GET_STRUCT_SIZE_IF_MATCHING(STRUCT_UI_PLAYING_ZONE);
		GET_STRUCT_SIZE_IF_MATCHING(STRUCT_UI_MESSAGE_DIALOG);
		//GET_STRUCT_SIZE_IF_MATCHING(STRUCT_UI_RGE_DIALOG_LIST); // unknown size
		//GET_STRUCT_SIZE_IF_MATCHING(STRUCT_UI_TLISTDIALOG); // unknown size
		GET_STRUCT_SIZE_IF_MATCHING(STRUCT_UI_RGE_VIEW);
		//GET_STRUCT_SIZE_IF_MATCHING(STRUCT_UI_SCREEN_PANEL); // unknown size
		...
		GET_STRUCT_SIZE_IF_MATCHING(STRUCT_UNIT_COMMANDABLE);
		GET_STRUCT_SIZE_IF_MATCHING(STRUCT_UNIT_BUILDING);
		GET_STRUCT_SIZE_IF_MATCHING(STRUCT_UNIT_MOVABLE);
		GET_STRUCT_SIZE_IF_MATCHING(STRUCT_UNIT_DOPPLEGANGER);
		GET_STRUCT_SIZE_IF_MATCHING(STRUCT_UNIT_FLAG);
		GET_STRUCT_SIZE_IF_MATCHING(STRUCT_UNIT_GROUP);
		GET_STRUCT_SIZE_IF_MATCHING(STRUCT_UNIT_TRAINABLE);
		...
		GET_STRUCT_SIZE_IF_MATCHING(STRUCT_UNIT_ATTACKABLE);
		GET_STRUCT_SIZE_IF_MATCHING(STRUCT_GAME_TIMELINE);
		GET_STRUCT_SIZE_IF_MATCHING(STRUCT_PATHING_SYSTEM);
	...
	char *GuessRORStructure(void *pData) {
		char *result = "";
		GET_STRUCT_NAME_IF_MATCHING(STRUCT_ACTION_ARTEFACT_CAPTURE);
		GET_STRUCT_NAME_IF_MATCHING(STRUCT_ACTION_ATTACK);
		GET_STRUCT_NAME_IF_MATCHING(STRUCT_ACTION_BUILD);
		GET_STRUCT_NAME_IF_MATCHING(STRUCT_ACTION_CONVERSION);
		GET_STRUCT_NAME_IF_MATCHING(STRUCT_ACTION_DISCOVERY_ARTEFACT);
		GET_STRUCT_NAME_IF_MATCHING(STRUCT_ACTION_EXPLORE);
		GET_STRUCT_NAME_IF_MATCHING(STRUCT_ACTION_FLY_BIRD);
		//GET_STRUCT_NAME_IF_MATCHING(STRUCT_ACTION_LINK); // No checksum
		GET_STRUCT_NAME_IF_MATCHING(STRUCT_ACTION_GARRISON_ENTER);
		GET_STRUCT_NAME_IF_MATCHING(STRUCT_ACTION_GATHER_WITH_ATTACK);
		GET_STRUCT_NAME_IF_MATCHING(STRUCT_ACTION_GATHER_WITHOUT_ATTACK);
		GET_STRUCT_NAME_IF_MATCHING(STRUCT_ACTION_GENERATE_WONDER_VICTORY);
		GET_STRUCT_NAME_IF_MATCHING(STRUCT_ACTION_HEAL);
		GET_STRUCT_NAME_IF_MATCHING(STRUCT_ACTION_MAKE_OBJECT);
		GET_STRUCT_NAME_IF_MATCHING(STRUCT_ACTION_MAKE_TECH);
		GET_STRUCT_NAME_IF_MATCHING(STRUCT_ACTION_MOVE);
		GET_STRUCT_NAME_IF_MATCHING(STRUCT_ACTION_PRODUCE_FARM_FOOD);
		GET_STRUCT_NAME_IF_MATCHING(STRUCT_ACTION_PROJECTILE);
		GET_STRUCT_NAME_IF_MATCHING(STRUCT_ACTION_REPAIR);
		GET_STRUCT_NAME_IF_MATCHING(STRUCT_ACTION_TRADE);
		GET_STRUCT_NAME_IF_MATCHING(STRUCT_ACTION_TRANSPORT);
		GET_STRUCT_NAME_IF_MATCHING(STRUCT_ACTIVE_SPRITE);
		GET_STRUCT_NAME_IF_MATCHING(STRUCT_ACTIVE_ANIMATED_SPRITE);
		GET_STRUCT_NAME_IF_MATCHING(STRUCT_ACTIVE_SPRITE_LIST);
		...
		GET_STRUCT_NAME_IF_MATCHING(STRUCT_CIVILIZATION_DEF);
		//GET_STRUCT_NAME_IF_MATCHING(STRUCT_UNIT_COMMAND_DEF); // No checksum
		GET_STRUCT_NAME_IF_MATCHING(STRUCT_UNIT_COMMAND_DEF_HEADER);
		...
		GET_STRUCT_NAME_IF_MATCHING(STRUCT_GAME_TIMELINE);
		...
		GET_STRUCT_NAME_IF_MATCHING(STRUCT_RMM_DB_CONTROLLER);
		...
		GET_STRUCT_NAME_IF_MATCHING(STRUCT_OBJECT_LIST);
		...
		GET_STRUCT_NAME_IF_MATCHING(STRUCT_SCENARIO_HEADER);
		//GET_STRUCT_NAME_IF_MATCHING(STRUCT_SCORE_ELEM); // No checksum
		GET_STRUCT_NAME_IF_MATCHING(STRUCT_VICTORY_CONDITIONS);
		...
		GET_STRUCT_NAME_IF_MATCHING(STRUCT_INFLUENCE_MAP);
		...
		GET_STRUCT_NAME_IF_MATCHING(STRUCT_UI_DROPDOWN_BUTTON);
		GET_STRUCT_NAME_IF_MATCHING(STRUCT_UI_BUTTON_WITH_NUMBER);
		//GET_STRUCT_NAME_IF_MATCHING(STRUCT_UI_CAMPAIGN_EDITOR);
		GET_STRUCT_NAME_IF_MATCHING(STRUCT_UI_CREDITS_SCREEN);
		GET_STRUCT_NAME_IF_MATCHING(STRUCT_UI_COMBOBOX);
		GET_STRUCT_NAME_IF_MATCHING(STRUCT_UI_DIALOG_BASE);
		GET_STRUCT_NAME_IF_MATCHING(STRUCT_UI_DIAMOND_MAP);
		GET_STRUCT_NAME_IF_MATCHING(STRUCT_UI_DIPLOMACY_DIALOG);
		GET_STRUCT_NAME_IF_MATCHING(STRUCT_UI_EASY_PANEL);
		GET_STRUCT_NAME_IF_MATCHING(STRUCT_UI_F11_POP_LABEL);
		GET_STRUCT_NAME_IF_MATCHING(STRUCT_GAME_COLORED_INFO_LABEL);
		GET_STRUCT_NAME_IF_MATCHING(STRUCT_UI_GAME_SETTINGS);
		GET_STRUCT_NAME_IF_MATCHING(STRUCT_UI_HORIZONTAL_SLIDER);
		GET_STRUCT_NAME_IF_MATCHING(STRUCT_UI_VERTICAL_SLIDER);
		GET_STRUCT_NAME_IF_MATCHING(STRUCT_UI_IN_GAME_MAIN);
		GET_STRUCT_NAME_IF_MATCHING(STRUCT_UI_IN_GAME_MENU);
		GET_STRUCT_NAME_IF_MATCHING(STRUCT_UI_IN_GAME_OPTIONS);
		GET_STRUCT_NAME_IF_MATCHING(STRUCT_UI_MESSAGE_PANEL);
		...
		GET_STRUCT_NAME_IF_MATCHING(STRUCT_UNIT_COMMANDABLE);
		GET_STRUCT_NAME_IF_MATCHING(STRUCT_UNIT_BUILDING);
		GET_STRUCT_NAME_IF_MATCHING(STRUCT_UNIT_MOVABLE);
		GET_STRUCT_NAME_IF_MATCHING(STRUCT_UNIT_DOPPLEGANGER);
		GET_STRUCT_NAME_IF_MATCHING(STRUCT_UNIT_FLAG);
		GET_STRUCT_NAME_IF_MATCHING(STRUCT_UNIT_GROUP);
		GET_STRUCT_NAME_IF_MATCHING(STRUCT_UNIT_TRAINABLE);
		...
		GET_STRUCT_NAME_IF_MATCHING(STRUCT_UNIT_ATTACKABLE);
		GET_STRUCT_NAME_IF_MATCHING(STRUCT_PATHING_SYSTEM);
